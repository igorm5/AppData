...
import com.notaumkm.db.BarangDAO;
import com.notaumkm.db.TransaksiDAO;
import com.notaumkm.model.Admin;
import com.notaumkm.model.Barang;
import com.notaumkm.model.ItemNota;
import com.notaumkm.model.Transaksi;
...
public class KasirFrame extends JFrame {
    ...
    private void initUI() {
        ...
        btnLogout = buatTombolKecil("⏻ Logout", new Color(90, 100, 115));
        ...
        btnBersihkan.addActionListener (e -> kosongkanKeranjang());
