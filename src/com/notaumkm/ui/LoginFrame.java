...
import com.notaumkm.db.AdminDAO;
...
public class LoginFrame extends JFrame {
    ...
    private void initUI() {
        setTitle("Login — Sistem Nota UMKM");
        ...
        JLabel lblTitle = new JLabel("SISTEM NOTA UMKM", SwingConstants.CENTER);
        lblTitle.setForeground(CLR_WHITE);
        lblTitle.setFont(new Font("Segoe UI", Font.BOLD, 22));

        JLabel lblSub = new JLabel("Point of Sale & Manajemen Stok", SwingConstants.CENTER);
        ...
        SwingWorker<Admin, Void> worker = new SwingWorker<>() {
            ...
            protected void done() {
                try {
                    ...
                    lblStatus.setForeground(new Color(200, 50, 50));
                    lblStatus.setText("Error koneksi database!");
                    btnLogin.setEnabled(true);
                }
            }
        };
